...
namespace Code.Game.Services.Time
{
    ...
    public class TimeObserver : IService, IInitializeListener, IStartListener, IUpdateListener, IProgressWriter
    {
        ...
        {
            _tickRangedTime = Container.Instance.GetConfig<TimeConfig>().TickRangedTime;
        ...
        {
            _currentTime += TimeSpan.FromSeconds(UnityEngine.Time.deltaTime);
        }

        private void _updateTickTime()
        {
            _currentDeltaTime += UnityEngine.Time.deltaTime;
